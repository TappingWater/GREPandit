...
const MenuTabs = ({
	...
	const dashboardStats: SubTab = {
		...
		id: 2,
		description:
			"Summary of the user's statistics over attempted problems over all sections",
		query: "stats",
	};
	...
	const quantStats: SubTab = {
		...
		id: 2,
		description:
			"Summary of the User's statistics over attempted quantitative problems",
		query: "stats",
	};
	const quantQuiz: SubTab = {
		...
		id: 3,
		description:
			"Tackle problems related to the quantitative section of the GRE exam",
		query: "quiz",
	};
	...
	const writingOverview: SubTab = {
		...
		id: 1,
		description:
			"Summary and tips for improving in the analytical writing section of the exam",
		query: "overview",
	};
	const writingStats: SubTab = {
		...
		id: 2,
		description:
			"Summary of the User's statistics over attempted analytical writing problems",
		query: "stats",
	};
	const writingQuiz: SubTab = {
		...
		id: 3,
		description:
			"Write an essay for a prompt given by the platform and have it critiqued and graded",
		query: "quiz",
	};
	const writingSubmissions: SubTab = {
		...
		id: 4,
		description:
			"List of user's previous submissions in the platform for review purposes",
		query: "submissions",
	};
	const writingLink = {
		href: "/writing",
	...
	const helpContact: SubTab = {
		...
		id: 1,
		description:
			"Feel free to contact us if you have any inquiries or issues. We're here to help",
		query: "contact",
	};
	const helpForum: SubTab = {
		...
		id: 2,
		description:
			"Public forum for platform user's to communicate with each other",
		query: "forum",
	};
	...
	const helpLink: MenuTab = {
		...
		description:
			"List of links to help the user resolve and discuss issues",
	};
